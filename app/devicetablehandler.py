...
class DeviceSecondaryPage:
  ...
  async def post(self, request):
    ...
    try:
      ...
      fields_to_load = [
          "device_sent", "device_id", "field_device_phone_number",
          "device_type", "ons_id"
      ]
    ...
    if get_device_info.status_code == 200:
      ...
      device_type_dropdown_options = device_type_dropdown(
          previous_criteria.get('device_type'))
      ...
      return {
          ...
          device_type_dropdown_options,
          'previous_device_id':
          previous_criteria.get('device_id'),
          'previous_field_device_phone_number':
          previous_criteria.get('field_device_phone_number'),
          'previous_ons_id':
          previous_criteria.get('ons_id'),
          'page_title':
          f'Device Table view for: {user_role}',
          'table_headers':
          table_headers,
