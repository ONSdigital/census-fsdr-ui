...
@search_routes.view('/interfaceactiontable')
class Search:
...
# Really just  interested in the above so that we  can  get another view working, as below is functionality for returning results
