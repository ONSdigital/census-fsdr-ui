    ...
    for history in full_history:
        if role_matchers.fsss_combined_regex.match(user_role):
            mapping = {
                ...
                'Status': history.pop('status', None),
                'Badge ID': history.pop('idBadgeNo', None),
                'Personal Email Address': history.pop('personalEmailAddress', None),
                'Postcode': history.pop('postcode', None),
                'Country': history.pop('country', None),
                'Emergency Contact Name': history.pop('emergencyContactFullName', None),
                'Emergency Contact Mobile Number': history.pop('emergencyContactMobileNo', None),
                'Weekly Hours': history.pop('weeklyHours', None),
                'Mobility': history.pop('mobility', None),
            }
            ...
            mapping = {
                ...
                'Badge ID': history.pop('idBadgeNo', None),
                'Personal Email Address': history.pop('personalEmailAddress', None),
                'Address': history.pop('address', None),
                'County': history.pop('county', None),
                'Postcode': history.pop('postcode', None),
                'Country': history.pop('country', None),
                'Emergency Contact Name': history.pop('emergencyContactFullName', None),
                'Emergency Contact Mobile Number': history.pop('emergencyContactMobileNo', None),
                'Date of Birth': history.pop('dob', None),
                'Weekly Hours': history.pop('weeklyHours', None),
                'Mobility': history.pop('mobility', None),
            }
